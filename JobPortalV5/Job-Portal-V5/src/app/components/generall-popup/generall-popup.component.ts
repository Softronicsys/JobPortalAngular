...
export class GenerallPopupComponent implements OnInit {
    ...
    get headingThemeColor(): string {
        return this.ThemeFontColor || this.DefaultFontColor || ("#" + Constants.default);
    }
    ...
    Color() {
        ...
        if (isNullOrUndefined(this.ClrThemeChng.ChangeTheme)) {
            ...
            const activeThemeColor = this.ThemeFontColor || this.forChanges;
            this.ThemeFontColor = activeThemeColor;
            this.BorderColor = "1px solid " + activeThemeColor;
